...
import { Library, Code2, BookOpen, ExternalLink, Monitor, Upload, SpellCheck } from "lucide-react";
...
const tools = [
  ...
  { icon: SpellCheck, title: "术语图鉴", desc: "AI Agent、Vibe Coding 专有名词通俗解释。不用会写代码，也能跟 AI 精准对话。配交互演示，一看就懂。", href: "/glossary", label: "开始学习", accent: "#d97757", status: "已上线" },

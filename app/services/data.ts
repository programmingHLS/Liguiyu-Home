...
export const serviceCategories: ServiceCategory[] = [
  {
    ...
    items: [
      { name: "Agent 安装", desc: "你的第一个 AI Agent，从零装好、跑通、能对话（OpenClaw 等）", price: "¥49 起" },
      { name: "Agent 配置调优", desc: "接模型 / API、Skills、权限…调到顺手为止", price: "¥49 起" },
      { name: "Agent 定制工作流", desc: "按需配自动化：邮件处理、GitHub、文件整理…", price: "¥99 起" },
      { name: "本地 AI 部署", desc: "Ollama / 本地大模型 / GPU 推理环境", price: "¥59 起" },

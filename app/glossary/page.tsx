  ...
  return (
    <>
      ...
      <div className="min-h-screen pt-[60px]" style={{ backgroundColor: colors.bg, fontFamily: "var(--font-body)" }}>
        ...
        <InteractiveSection id="glossary-list" theme="lab" className="!min-h-0 !py-8">
        ...
        {/* Category tabs */}
        {!searchResults && (
          <div className="flex gap-2 glossary-scroll pb-3 mb-6 -mx-1 px-1">
            ...
            {termsToShow.map((term, index) => (
              ...
              >
                ...
                >
                  ...
                  {/* Visual preview */}
                  <TermPreview previewType={term.preview} termName={term.name} termEn={term.en} category={activeCategory} />
                </Link>
              </motion.div>
            ))}
          </AnimatePresence>
